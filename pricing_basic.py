...
def def_pricing_basic(prices_in_vesta, art_dubl_df, prices_LT):
    ...
    # print(prices_LT_merge_art_dubl.head(5))
...
# nomenclature_change.to_excel(file_directory_prices_in_vesta + 'Закачка Световые Технологии' + file_name_prices[7:-5] +'_basic.xlsx', sheet_name='ActualCeni', index=False)